...
def gen_pdf(request):
    ...
    if request.method == "POST":
        ...
        mymodel = User(name= name, about= about, pro1= pro1, pd1=pd1, pro2=pro2, pd2=pd2, pro3=pro3, pd3=pd3, ach1=ach1,ad1=ad1, ach2=ach2, ad2=ad2, ach3=ach3, ad3=ad3, adress=address,number=number,email=email)
        mymodel.save()
